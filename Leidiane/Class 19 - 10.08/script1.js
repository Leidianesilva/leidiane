...
function init(){
    var paramPesquisa = "Da Vinci Code";
    var init = 0;
    for (var i=0; i< this.books.data.lenght; i++){
        init += books.data.lenght[i];
    }
    ...
    var book1 = new Book (items.imageLinks, items.volumeInfo, items.Description);
